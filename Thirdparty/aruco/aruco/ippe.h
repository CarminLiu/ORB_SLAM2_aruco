...
namespace aruco
{
    // returns the two solutions    std::vector<cv::Mat>
    std::vector<std::pair<cv::Mat,double> > solvePnP(const std::vector<cv::Point3f>& objPoints, const std::vector<cv::Point2f>& imgPoints,
